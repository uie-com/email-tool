...
// export function parseVariables(text: string): Variables {

//     return new Variables(text);

// let index = 0, variables = new Variables(), isInStyleTag = 0;
...
export function fillQuillVariables(variables: Variables, values: Values): Op[] {
    ...
    variables.sortVariables().forEach(variable => {
        ...
        let value = values.getFinalValue(variable.name);
