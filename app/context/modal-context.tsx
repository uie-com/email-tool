...
import { Anchor, Box, Button, Flex, Loader, Modal, Text, TextInput } from "@mantine/core";
                ...
                (<Flex direction="column" align="center" justify="center" gap={30} className="w-full h-full">
                    ...
                    <Flex justify="start" align="center" className="w-full" gap={20}>
                        ...
                        <Button variant="filled" color="red" className="min-h-10 max-w-48" onClick={async () => {
                            ...
                            if (templateId)
                                result = result && await deleteTemplate(templateId);
                            if (campaignId)
                                result = result && await deleteCampaign(campaignId, globalSettings.activeCampaignToken ?? '');
