...
import { RemoteStatus } from "@/app/components/remote/step-template";
...
import { testActiveCampaignToken } from "@/domain/integrations/active-campaign/api";
import { getToken, testGoogleToken } from "@/domain/integrations/google-drive/googleActions";
...
import { Button, DefaultMantineColor, Flex, Image } from "@mantine/core";
...
export function EmailPublisher() {
    ...
    const sendType = normalizeName(editorState.email?.values?.resolveValue('Send Type'));
