...
import { CONFIRMATION, CONTENT, MESSAGE, RECEIPT, VESSEL } from "../shared-emails";
...
export const WIN: Settings<ValuePart<any>> = {
    'Program:Win': {
        settings: {
            ...
            'Promo Banner': { value: 'https://content.app-us1.com/O8aW3/2025/05/05/4756c528-8308-4f1b-a870-2a9c8dd8aa1b.png?id=39155999', hide },
        },
