...
export const RESEARCH: Settings<ValuePart<any>> = {
    'Program:Research': {
        ...
        'Email Type:Today\'s Session': {
            ...
            'Topic:Topic 1': { settings: { 'Source Collab Notes Doc': { value: 'https://docs.google.com/document/d/1ES80oE15Ps5jCNoNTRUtfgS22Fl91PVVv-93nvd-Glk/edit?usp=share_link' } } },
            'Topic:Topic 2': { settings: { 'Source Collab Notes Doc': { value: 'https://docs.google.com/document/d/1poajikSzWpfzD8N8lBps0jCZFHy5QCyGKxkWEb2BaBA/edit?usp=share_link' } } },
            'Topic:Topic 3': { settings: { 'Source Collab Notes Doc': { value: 'https://docs.google.com/document/d/17aRSWdHCRehgk-PuLd305Pa3THUbQvedznJxVU5QLi8/edit?usp=share_link' } } },
            'Topic:Topic 4': { settings: { 'Source Collab Notes Doc': { value: 'https://docs.google.com/document/d/1pUNgTjKv62VERiLcHlVnuaoDgvnKo9t2_JRadvztxlg/edit?usp=share_link' } } },
            'Topic:Topic 5': { settings: { 'Source Collab Notes Doc': { value: 'https://docs.google.com/document/d/1_HtbVbWNxbkOMFXMQaRU_Ud8BSjGZo1IvFyT5P8dPnA/edit?usp=share_link' } } },
            'Topic:Topic 6': { settings: { 'Source Collab Notes Doc': { value: 'https://docs.google.com/document/d/1oMoS_Zjsgru27AW6B_Zi8fZxsMd6AHf7fxpT7bc2_M0/edit?usp=share_link' } } },
            'Topic:Topic 7': { settings: { 'Source Collab Notes Doc': { value: 'https://docs.google.com/document/d/17VTL3sgEXmWUGu1s-YKgD_xUBenEGytuarlsV02TBaI/edit?usp=share_link' } } },
            'Topic:Topic 8': { settings: { 'Source Collab Notes Doc': { value: 'https://docs.google.com/document/d/1LsuOGJ0YquStDH0WhA8n7p3wqehCSq_7x8dl9GOmfjs/edit?usp=share_link' } } },
        },
