...
export const TODAYS_SESSION: Settings<ValuePart<any>> = {
  "Email Type:Today's Session ": {
    settings: {
      ...
      "Stripo Link": {
        value: "https://my.stripo.email/editor/v5/727662/email/9551152",
        hide,
      },
...
export const BEFORE_WEEK: Settings<ValuePart<any>> = {
  "Email Type:Before Week ": {
    settings: {
      ...
      "Stripo Link": {
        value: "https://my.stripo.email/editor/v5/727662/email/9551147",
        hide,
      },
      ...
      Subject: {
        value:
          "{Program Name}: {Next Week}: Topics {{Next Week} Session #1 Topic (#)} + {{Next Week} Session #2 Topic (#)}",
      },

      // CONTENT
      "Session Title Number": {
        value: "[[Next Week] Session #1 Topic (#)]",
        hide,
      },
      "Session Message": {
        value: `
    ...
    "Next Week:Week 2": {
      settings: {
        ...
        "Stripo Link": {
          value: "https://my.stripo.email/editor/v5/727662/email/9551146",
          hide,
        },
      },
    },
    "Is First Session Of Program": {
      "Week:Week 1": {
        settings: {
          ...
          Subject: {
            value:
              "{Program Name}: {Week}: Topics {{Week} Session #1 Topic (#)} + {{Week} Session #2 Topic (#)}",
          },

          // TEMPLATE
          Template: { value: "/before-week-1.html", part: 2 },
          "Stripo Link": {
            value: "https://my.stripo.email/editor/v5/727662/email/9551144",
            hide,
          },
        },
      },
...
export const CERTIFICATE: Settings<ValuePart<any>> = {
  "Email Type:Certificate ": {
    settings: {
      ...
      "Send Type": { value: "POSTMARK", hide },
      Subject: {
        value: "Your Certificate for the {Program Name} Online Course",
      },

      // TEMPLATE
      Template: { value: "/certificate.html", part: 2 },
      "Stripo Link": {
        value: "https://my.stripo.email/editor/v5/727662/email/9552708",
        hide,
      },
    },
  },
...
export const RECEIPT: Settings<ValuePart<any>> = {
  "Email Type:Receipt ": {
    settings: {
      ...
      "Stripo Link": {
        value: "https://my.stripo.email/editor/v5/727662/email/9540829",
        hide,
      },
...
export const CONFIRMATION: Settings<ValuePart<any>> = {
  "Email Type:Confirmation ": {
    settings: {
      ...
      "Stripo Link": {
        value: "https://my.stripo.email/editor/v5/727662/email/9548503",
        hide,
      },
    ...
    "Program:Visions": {
      settings: {
        "Confirmation Message": {
          value: `Together, let's bring to focus a clear vision of highly desirable experiences.`,
        },
      },
    },
    "Program:Metrics": {
      settings: {
        "Confirmation Message": {
          value: `<br/><br/>Outcome-driven UX Metrics focus you, your team, stakeholders, and executives on improving your customers' and users' lives.`,
        },
      },
    },
    "Program:Research": {
      settings: {
        "Confirmation Message": {
          value: `Together, let's lead your organization to become the foremost expert in your users and customers.`,
        },
      },
    },
  },
